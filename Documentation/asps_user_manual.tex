...
the temperature has reached a specified target (typically $-40\,\deg\mbox{C}$)
via the use of an onboard adjustable heater. It is the only section
of the ASPS-DAQ board which is required to operate to $-55\,\deg\mbox{C}$.
...
into bootstrap mode is done via the Web interface.
